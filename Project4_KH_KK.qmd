...
create_state_law_info <- function(state) {
  state_laws <- list(
    "Virginia" = list(
      ...
      exceptions = "Exceptions: After 26 weeks, to save the pregnant person's life, to preserve the pregnant person's general health (can include mental health).\n",
      parental_consent = "Parental Consent Required: YES; must be notified of decision 24 hours prior to abortion.\n",
      waiting_period_or_counseling = "Waiting Period or Counseling Required: NO"
    ),
    "Maryland" = list(
      gestational_limit = "Gestational Limit: Legal throughout pregnancy.\n",
      parental_consent = "Parental Consent Required: NO; however, parent or guardian must be notified before a minor has an abortion, exceptions allowed.\n",
      waiting_period_or_counseling = "Waiting Period or Counseling Required: NO"
    ),
    "North Carolina" = list(
      gestational_limit = "Gestational Limit: 12 weeks from the first day of your last menstrual period.\n",
      exceptions = "Exceptions: After 12 weeks, in case of rape or incest abortion allowed through week 20, life-limiting fetal anomaly abortion allowed through week 24, if the patient's life is in danger or there is a severe health risk, abortion allowed at any point.\n",
